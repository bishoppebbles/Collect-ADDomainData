...
12. Policy 1) Enable the WinRM Service.  Navigate to:
  a. Computer Configuration > Policies > Administrative Templates > Windows Components > Windows Remote Management (WinRM) > WinRM Service > Allow remote server management through WinRM
...
14. Policy 2) Set the WS-Management service to automatic startup.  Navigate to:
  a. Computer Configuration > Policies > Windows Settings > Security Settings > System Services > Windows Remote Management (WS-Management)
...
16. Policy 3) Allow Windows Remote Management in the Firewall.  Navigate to:
  a. Computer Configuration > Policies > Windows Settings > Security Settings > Windows Defender Firewall with Advanced Security > Windows Defender Firewall with Advanced Security
    i. Right click on ‘Inbound Rules’ and select ‘New Rule’.
